                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="closings-list">
                        ...
                        <p v-if="closings.length > 0" v-for="closing in closings">- Cierre de datos en la fecha <strong>{{ closing.created_at | moment("DD, MMMM") }} de {{ closing.created_at | moment("YYYY") }}</strong>.</p>
                      </div>
                    </div>
                </div>
            </div>
