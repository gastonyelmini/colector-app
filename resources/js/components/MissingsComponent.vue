                    ...
                    <div class="card-body">
                      <div class="closings-list">
                        <div class="search-input">
                          <p>Buscar por <strong>nombre</strong>, <strong>apellido</strong> , <strong>DNI</strong>, <strong>domicilio</strong> o <strong>escuela.</strong></p>
  ...
  computed: {
    filteredNames() {
      return Object.values(this.remainings).filter(rmdObject => {
        var filterData = rmdObject.name_lastname + " " + rmdObject.dni + ' ' + rmdObject.address + ' ' + rmdObject.school;
